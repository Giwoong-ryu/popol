...
const experiences: ExperienceItem[] = [
  {
    company: '카페사업단 운영 및 가맹점 관리',
    position: '카페사업단 팀장 | 부산동래지역자활센터',
    period: '2023.02 ~ 2025.01',
    location: '부산',
    responsibilities: [
      '자활센터 소속 카페 매장 3곳 신규 오픈 및 운영',
      '블루샥 가맹점 1곳 관리 담당 (센터 지원으로 오픈한 매장)',
      '신입 직원 대상 커피 이론 교육 진행',
    ],
    achievements: [
      '블루샥 점주 지원: 본사에서 늦어지는 이벤트 디자인 등 직접 제작하여 전달',
      '매출 부진 점주에게 배달앱 리뷰 관리 방법 공유',
      '11페이지 교육자료 제작, 신입 교육 기간 1달→2주로 단축',
    ],
  },
  {
    company: '사내카페 오픈 프로젝트',
    position: '프로젝트 담당 | 해운회사',
    period: '2024.09 (1개월)',
    location: '부산',
    responsibilities: [
      '사내 카페 신규 오픈 준비 담당',
      '반경 1km 내 경쟁업체 14곳 직접 방문 조사',
      '인테리어 업체 3곳 비교 견적 및 협의',
    ],
    achievements: [
      '인테리어 비용 1.5억 → 1.3억으로 협의 (2,000만원 절감)',
      '문서정리 어려워하는 직원들 위해 간단한 정리 프로그램 만들어서 전달',
    ],
  },
  {
  ...
  },
  {
    ...
    achievements: [
      ...
      '매각 성과: 코로나 시기 운영(2인 운영), 수제 제작으로 원가율 20%대 초반 유지',
