...
const cases: PhilosophyItem[] = [
  ...
  {
    title: "운영 비효율 개선",
    problem: "직원들끼리 말로만 전달하다보니 빠뜨리는 일이 많고, 신입은 1달이 지나야 일에 적응했어요",
    solution: "메뉴얼을 누구나 보면 바로 따라할 수 있게끔 상세히 제작했어요. 체크리스트도 벽에 붙여서 빠뜨리는 일이 없도록",
    result: "업무 누락 없어지고, 신입 2주 안에 적응 완료했어요"
  }
];
